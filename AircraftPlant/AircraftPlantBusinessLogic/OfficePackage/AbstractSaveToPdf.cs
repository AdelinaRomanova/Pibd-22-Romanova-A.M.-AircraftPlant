	...
	public abstract class AbstractSaveToPdf
	{
		public void CreateDoc(PdfInfo info)
		{
            ...
            foreach (var order in info.Orders)
            {
                CreateRow(new PdfRowParameters
                {
                    Texts = new List<string> { order.DateCreate.ToShortDateString(), order.ClientFIO, order.PlaneName, order.Count.ToString(), order.Sum.ToString(), order.Status.ToString()},
                    Style = "Normal",
